...
export default function Predicciones() {
  ...
  const fixture: Partido[] = [
    ...
    { id: '8', etapa: 'grupos', fase_nro: 1, grupo: 'GRUPO D', local: 'AUSTRALIA', bandera_local: '🇦🇺', visitante: 'TURQUIA', bandera_visitante: '🇹🇷', fecha: '14 de Junio', fecha_iso: '2026-06-14', hora: '1:00', jugadores: ['Patrick Beach', 'Paul Izzo', 'Aziz Behich', 'Jordan Bos', 'Cameron Burgess', 'Alessandro Circati', 'Milos Degenek', 'Jason Geria', 'Lucas Herrington', 'Jacob Italiano', 'Harry Souttar', 'Kai Trewin', 'Cameron Devlin', 'Ajdin Hrustić', 'Jackson Irvine', 'Connor Metcalfe', 'Paul Okon-Engstler', 'Aiden ONeill', 'Nestory Irankunda', 'Mathew Leckie', 'Awer Mabil', 'Mohamed Touré', 'Nishan Velupillay', 'Cristian Volpato', 'Tete Yengi',
    ] },
    ...
    { id: '24', etapa: 'grupos', fase_nro: 1, grupo: 'GRUPO K', local: 'UZBEKISTÁN', bandera_local: '🇺🇿', visitante: 'COLOMBIA', bandera_visitante: '🇨🇴', fecha: '17 de Junio', fecha_iso: '2026-06-17', hora: '23:00', jugadores: ['Camilo Vargas', 'David Ospina', 'Álvaro Montero', 'Daniel Muñoz', 'Santiago Arias', 'Yerry Mina', 'Davinson Sánchez', 'Jhon Lucumí', 'Willer Ditta', 'Yohan Mojica', 'Déiver Machado', 'Richard Ríos', 'Jefferson Lerma', 'Gustavo Puerta', 'Kevin Castaño', 'Jhon Arias', 'James Rodríguez', 'Juan Fernando Quintero', 'Jorge Carrascal', 'Juan Camilo Portilla', 'Luis Díaz', 'Luis Suárez', 'Carlos Gómez', 'Jaminton Campaz', 'Jhon Córdoba', 'Juan Camilo Hernández',
         'Utkir Yusupov', 'Botirali Ergashev', 'Abdovkih Nematov', 'Rustamjon Ashurmatov', 'Umarbek Eshmurodov', 'Avazbek Ylmasaliev', 'Abduqodir Khusanov', 'Abdulla Abdulaev', 'Jakhongir Urozov', 'Khojiakbar Alijonov', 'Berhuz Karimov', 'Ruslanbek Jiyanov', 'Farrukh Sayfiev', 'Sherzos Nasrrulaev', 'Umarali Rakmonaliev', 'Azizjon Ganiev', 'Akmal Mozgovoy', 'Sherzod Ezanov', 'Otakeb Shukubov', 'Odiljon Khamrobekov', 'Dostonbek Khamdamov', 'Jamshid Iskanderov', 'Jasur Jaloliddinov', 'Abbosek Fayzullaev', 'Oston Urunov', 'Jaloliddin Masharipov', 'Azizbek Amonov', 'Eldor Shomurodov', 'Igor Sergeev', 'Sherdoz Temirov'] },
    ...
    { id: '32', etapa: 'grupos', fase_nro: 2, grupo: 'GRUPO D', local: 'TURQUÍA', bandera_local: '🇹🇷', visitante: 'PARAGUAY', bandera_visitante: '🇵🇾', fecha: '20 de Junio', fecha_iso: '2026-06-20', hora: '0:00', jugadores: [
         'Orlando Gill', 'Roberto Jr. Fernández', 'Gastón Olveira', 'Juan José Cáceres', 'José Canale', 'Fabián Balbuena', 'Omar Alderete', 'Gustavo Gómez', 'Alexandro Maidana', 'Junior Alonso', 'Gustavo Velázquez', 'Braian Ojeda', 'Damián Bobadilla', 'Andrés Cubas', 'Diego Gómez Gómez', 'Alejandro Romero Gamarra', 'Mauricio Prado', 'Matías Galarza', 'Ramón Sosa', 'Gustavo Caballero', 'Miguel Almirón', 'Gabriel Ávalos', 'Isidro Pitta', 'Álex Arce', 'Julio Enciso', 'Antonio Sanabria'] },
