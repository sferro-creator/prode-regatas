...
export default function Predicciones() {
  ...
  const fixture: Partido[] = [
    ...
    { id: '8', etapa: 'grupos', fase_nro: 1, grupo: 'GRUPO D', local: 'AUSTRALIA', bandera_local: '🇦🇺', visitante: 'TURQUÍA', bandera_visitante: '🇹🇷', fecha: '14 de Junio', fecha_iso: '2026-06-14', hora: '1:00', jugadores: ['Patrick Beach', 'Paul Izzo', 'Aziz Behich', 'Jordan Bos', 'Cameron Burgess', 'Alessandro Circati', 'Milos Degenek', 'Jason Geria', 'Lucas Herrington', 'Jacob Italiano', 'Harry Souttar', 'Kai Trewin', 'Cameron Devlin', 'Ajdin Hrustić', 'Jackson Irvine', 'Connor Metcalfe', 'Paul Okon-Engstler', 'Aiden ONeill', 'Nestory Irankunda', 'Mathew Leckie', 'Awer Mabil', 'Mohamed Touré', 'Nishan Velupillay', 'Cristian Volpato', 'Tete Yengi',
    ...
    { id: '32', etapa: 'grupos', fase_nro: 2, grupo: 'GRUPO D', local: 'TURQUÍA', bandera_local: '🇹🇷', visitante: 'PARAGUAY', bandera_visitante: '🇵🇾', fecha: '20 de Junio', fecha_iso: '2026-06-20', hora: '0:00', jugadores: ['Altay Bayındır', 'Mert Günok', 'Uğurcan Çakır', 'Abdülkerim Bardakcı', 'Merih Demiral', 'Çağlar Söyüncü', 'Eren Elmalı', 'Ferdi Kadıoğlu', 'Mert Müldür', 'Ozan Kabak', 'Samet Akaydin', 'Zeki Çelik', 'Hakan Çalhanoğlu', 'İsmail Yüksek', 'Kaan Ayhan', 'Orkun Kökçü', 'Salih Özcan', 'Arda Güler', 'Barış Alper Yılmaz', 'Can Uzun', 'Erencan Yardımcı', 'İrfan Can Kahveci', 'Kenan Yıldız', 'Kerem Aktürkoğlu', 'Oğuz Aydın', 'Semih Kılıçsoy',
         'Orlando Gill', 'Roberto Jr. Fernández', 'Gastón Olveira', 'Juan José Cáceres', 'José Canale', 'Fabián Balbuena', 'Omar Alderete', 'Gustavo Gómez', 'Alexandro Maidana', 'Junior Alonso', 'Gustavo Velázquez', 'Braian Ojeda', 'Damián Bobadilla', 'Andrés Cubas', 'Diego Gómez Gómez', 'Alejandro Romero Gamarra', 'Mauricio Prado', 'Matías Galarza', 'Ramón Sosa', 'Gustavo Caballero', 'Miguel Almirón', 'Gabriel Ávalos', 'Isidro Pitta', 'Álex Arce', 'Julio Enciso', 'Antonio Sanabria'] },
