...
export default function Predicciones() {
  ...
  const fixture: Partido[] = [
    ...
    { id: '11', etapa: 'grupos', fase_nro: 1, grupo: 'GRUPO F', local: 'ARGENTINA', bandera_local: '🇦🇷', visitante: 'SUECIA', bandera_visitante: '🇸🇪', fecha: '16 de Junio', hora: '16:00 hs', jugadores: ['Lionel Messi', 'Alexis Mac Allister', 'Alexander Isak'] },
